...
import { runAnalyze, runTree, runWhere, runTopic, runSummary, runView, runLive } from "./cli/commands";
...
Usage:
  ...
  npx ts-node src/index.ts live             Start live mode (text input in browser)
  npx ts-node src/index.ts live --mic       Start live mode with microphone (requires Deepgram)
